...
payload_wrong = {"title " : "Διάβασμα για τα Αγγλικά",
                 "priority": "HIGH",
                 "completed": "True"}
...
res2=requests.post("http://127.0.0.1:8000/create-task")

print("Check για το σκοπίμως λάθος άιτημα")
print("Status Code", res2.status_code)
print("Απάντηση : ", res2.json())
